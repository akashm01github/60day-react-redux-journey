...
import { decreaseCartItemQuantity, increaseCartItemQuantity, removeCartItem } from '../store/slice/cartSlice';
  ...
  return (
    <div className="cart-item-container">
      ...
      <div className="item-quantity">
        ...
        <i  onClick={()=>dispatch(removeCartItem({productId}))} className="ri-delete-bin-5-fill dlt_btn"></i>
      </div>
