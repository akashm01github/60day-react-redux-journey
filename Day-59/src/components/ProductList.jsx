            ...
            <div className='flex justify-center flex-wrap items-center gap-5 py-5 px-2'>
                {
                    products.map(({ id, title, price, image }) => {
                        ...
                        >
                            ...
                            <h3 className='font-semibold text-left text-xl'>{title}</h3>
                            <div className='flex justify-between items-center w-full px-2 py-3'>
                                <p>★ ★ ★ ★</p>
                                <p>{price}</p>
                            </div>
                            <div className='flex justify-between items-center w-full px-2 py-3'>
                                <button onClick={() => { dispatch(addTocart({ productId: id, title, price, image })) }} className='px-4 py-2 font-semibold bg-amber-400 rounded-2xl active:scale-90'>Add to Cart</button>
